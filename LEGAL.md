...
Licence : [PolyForm Noncommercial 1.0.0](LICENSE). Usage non commercial.
...
Mr-Aurevo-X **ne collecte aucune donnée personnelle**. Pas de compte, pas de télémétrie.
...
Contact : dépôt `Mr-Aurevo-X/Linux-Command`.

<!-- lang:en -->
# Legal notice — Linux Command

**Copyright © 2026 Mr-Aurevo-X.** All rights reserved on the name, marks, and artwork.

License: [PolyForm Noncommercial 1.0.0](LICENSE). Noncommercial use.
...
Mr-Aurevo-X **collects no personal data**. No account, no telemetry.
...
Contact: repo `Mr-Aurevo-X/Linux-Command`.
