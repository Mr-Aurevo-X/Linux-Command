...
Logiciel fourni pour un usage non commercial (`LICENSE`), sans installation silencieuse. Un clic Installer ouvre le dépôt GitHub du hub.

Soutien facultatif : Discord, crypto (in-app).
