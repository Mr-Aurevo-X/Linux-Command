...
const DICT = {
  fr: {
    ...
    installBody: "Copie l’adresse du dépôt GitHub, ou ouvre-la dans le navigateur.",
    noRelease: "Release pas encore publiée",
    btnInstall: "Ouvrir le dépôt",
    confirmCancel: "Fermer",
    ...
    privacy: "Local-first, pas de télémétrie. GitHub : vérif. versions (option À propos). Installer ouvre le dépôt du hub.",
    ...
    aboutLegalGh: "GitHub : vérif. versions (option) ; Installer ouvre le dépôt du hub",
    ...
    aboutHintOff: "Désactivé : aucune requête Latest. Ouvrir un dépôt reste un clic explicite.",
  ...
  en: {
    ...
    installBody: "Copy the GitHub repository URL, or open it in the browser.",
    noRelease: "Release not published yet",
    btnInstall: "Open repository",
    confirmCancel: "Close",
    ...
    privacy: "Local-first, no telemetry. GitHub: version check (About option). Install opens the hub repository.",
    ...
    aboutLegalGh: "GitHub: version check (option); Install opens the hub repository",
    ...
    aboutHintOff: "Disabled: no Latest request. Opening a repository stays an explicit click.",
